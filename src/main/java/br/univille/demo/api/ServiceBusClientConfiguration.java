...
public class ServiceBusClientConfiguration {
    ...
    private static final String SUBSCRIPTION_NAME = "subsPedroZimmermann";
    private static final String QUEUE_NAME = "queue-zimmermann";

    @Bean
    ServiceBusClientBuilder serviceBusClientBuilder() {  //oq ta acontecemdp aqui eh que ele ta criando um objeto do tipo ServiceBusClientBuilder
